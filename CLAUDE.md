...
- `harness/` — custom agent-loop code built on `claude-agent-sdk`: session orchestration, permission/hook wiring, subagent definitions.
...
- `notes/` — versioned knowledge base (see `notes/README.md`).
